...
export const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-sm hover:cursor-pointer transition duration-250 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2",
  {
    variants: {
      variant: {
        primary:
        ...
        secondary:
          "bg-white text-black border-solid border-2 border-[#010205] hover:bg-gray-300 ",
